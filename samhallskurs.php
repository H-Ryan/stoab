                    ...
                    <div class="grid_12">
                        <div class="box_1">
                            <p class="text_3">
                                ...
                                <br/><br/>
                                Mål<br/>Vår målsättning är att nyanlända ska lära sig känna till och förstå sina
                                rättigheter och skyldigheter inom områden såsom arbetsliv, utbildning och
                                hälsa.<br/><br/>
                            </p>
                        </div>
                    </div>
                    <div class="grid_8">
                        <div class="wrap_10">
                            ...
                            <ul class="list_2 text_3 color_5">
                                <li>Att komma till Sverige</li>
                                <li>Att bo i Sverige</li>
                                <li>Att bilda familj och leva med barn i Sverige</li>
                                <li>Att påverka Sverige</li>
                                <li>Att vårda sin hälsa i Sverige</li>
                                <li>Att åldras i Sverige</li>
                                <li>Rättigheter och skyldigheter i Sverige</li>
                                <li>Traditioner i Sverige</li>
                            </ul>
                        </div>
                    </div>
                    <div class="grid_12">
                        <div class="box_1">
                            <p class="text_3">
                                Undervisningsform<br/>Undervisningen kommer ske i förläsningsform och där finns utrymme
