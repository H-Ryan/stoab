                ...
                <div class="grid_12">
                    <div class="box_1">
                        <p class="text_3">
                            ...
                            <br/><br/>
                            Studiehandledning på modersmålet ska stödja elever som riskerar att inte nå de kunskapskrav som minst ska uppnås i ett eller flera ämnen.
                            <br/><br/>
                        </p>
                    </div>
                </div>
                ...
                <div class="grid_8">
                    <div class="wrap_10">
                        ...
                        <ul class="list_2 text_3 color_5">
                            <li>Behärskar modersmålet</li>
                            <li>Har en utvecklad språkmedvetenhet</li>
                            <li>Är pedagogisk kunnig</li>
                            <li>Är förtrogen med svensk skola</li>
                            <li>Är målfokuserad</li>
                            <li>Är ämneskunnig</li>
                        </ul>
                    </div>
                </div>
            </div>
