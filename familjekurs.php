                    ...
                    <div class="grid_8">
                        <div class="wrap_10">
                            ...
                            <ul class="list_2 text_3 color_5">
                                <li>Olika sätt att leva ihop</li>
                                <li>Vårdnad av barn</li>
                                <li>Föräldrarollen</li>
                                <li>Ekonomiskt stöd till familjer</li>
                                <li>Socialtjänstlagen</li>
                                <li>Barnomsorg</li>
                                <li>Grundskola</li>
                                <li>Gymnasium</li>
                                <li>Skola och demokrati</li>
                            </ul>
                        </div>
                    </div>
                    <div class="grid_12">
                        <div class="box_1">
                            <p class="text_3">
                                Undervisningsform<br/>Undervisningen kommer ske i förläsningsform och där det finns
                                utrymme för diskussioner och frågor. Undervisaren delar ut material som krävs.
                                <br/><br/>
