...
<link rel="stylesheet" href="docs/style.css" type="text/css">
		...
		<script type="text/javascript">
			WYSIWYG.attach('textarea2', full);</script>
...
<form action="?do=save_file&where=<?=$where?>&file=<?=$_GET['file']?>" method="post" enctype="multipart/form-data">
  <textarea id='textarea2' name='test2' style='width:860px;height:500px;'><?=$data?>
</textarea>
  <label>
...
<br />
<br />
<span style="size:14px; border-bottom:dotted #333; 1px;">Support: 031-880005 , 08-228005 , 033-207500</span></div>
</body></html>