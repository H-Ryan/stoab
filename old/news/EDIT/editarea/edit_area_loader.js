	...
	*/	
	...
	get_control_html : function(button_name, lang) {		
		...
		switch (button_name){
			...
			case "select_font":
				html= "<select id='area_font_size' onchange='editArea.execCommand(\"change_font_size\")' fileSpecific='yes'>";
			...
			case "syntax_selection":
				html= "<select id='syntax_selection' onchange='editArea.execCommand(\"change_syntax\", this.value)' fileSpecific='yes'>";
