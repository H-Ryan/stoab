            ...
            <div class="container">
                <div class="row">
                    <div class="preffix_2 grid_8">
                        <h2 class="header_1 wrap_3 color_8">
                            Översättning
                        </h2>
                    </div>
                </div>
                <div class="row">
                    <div class="grid_12">
                        <div class="box_1">
                            <p class="text_3">
                                Vi på STÖ översätter all form av dokumentation. Exempelvis validerar vi körkort och
                                betyg. Vi översätter juridiska dokument, dokument från myndigheter, bank, försäkringar,
                                sjukvård osv på alla språk.
                                <br/><br/>
                                Våra översättare väljs ut med omsorg och vi är noga med att matcha texten som ska
                                översättas med lämplig kunskapsprofil.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid_4">
                        <div class="wrap_10">
                            <div class="box_6">
                                ...
                                <div class="caption">
                                    <p class="text_3">
                                        Dessa översättningar är genomförda och granskade av sakkunniga översättare.
                                    </p>
                                </div>
                            ...
                            <div class="box_6">
                                ...
                                <div class="caption">
                                    <p class="text_3">
                                        Grammatik, stavning och avstavningar kontrolleras ingående.
                                    </p>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="box_6">
                                ...
                                <div class="caption">
                                    <p class="text_3">
                                        Auktoriserade translatorer stämplar texten intygar att denne överensstämmer med
                    ...
                    <div class="grid_4">
                        <div class="wrap_10">
                            <div class="box_6">
                                <div class="put-left">
                                    <div class="caption">
                                        <img src="images/index-4_img04.jpg" alt="Image 1"/>
                                ...
                                <div class="caption">
                                    <p class="text_3">
                                        Ursprungstexten och målgruppen tas hänsyn till och översättningen kontrolleras.
                                    </p>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="box_6">
                                <div class="put-left">
                                    <div class="caption">
                                        <img src="images/index-4_img05.jpg" alt="Image 2"/>
                                ...
                                <div class="caption">
                                    <p class="text_3">
                                        Bearbetning och målgruppsanpassning sker av manus på svenska eller andra språk.
                                    </p>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="box_6">
                                <div class="put-left">
                                    <div class="caption">
                                        <img src="images/index-4_img06.jpg" alt="Image 3"/>
                                ...
                                <div class="caption">
                                    <p class="text_3">
                                        Texten som översätts läggs in i en grafisk mall med bilder och textanpassas
                                    </p>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                    ...
                    <div class="grid_4">
                        <div class="wrap_10">
                            <h2 class="header_2 indent_3">
                                Fler exempel på översättningar som vi gör
                            </h2>
                            <ul class="list_2 text_3 color_5">
                                <li>Juridisk översättning</li>
                                <li>Ekonomisk översättning</li>
                                <li>Medicinsk översättning</li>
                                <li>Teknisk översättning</li>
                                <li>EU-dokumentation</li>
                                <li>Försäkringsärenden</li>
                                <li>Rapporter</li>
                                <li>Broschyrer</li>
                                <li>Reklam-, marknadsförings- och informationsmaterial</li>
                                <li>Webbsidor</li>
                            </ul>
                        </div>
                    </div>
