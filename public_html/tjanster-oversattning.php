    ...
    <div role="main" class="main">
        <section class="page-header page-header-light p-sm">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <h2 class="mt-md mb-md" style="font-size:1.8em">Tjänster /<span class="heading-quaternary">Översättning</span>
                        </h2>
                    </div>
                    <div class="col-md-9">
            ...
            <div class="row">
                <div class="col-md-9">
                    <ul class="history">
                        ...
                        <li class="appear-animation" data-appear-animation="fadeInUp">
                            <div class="thumb">
                                <img src="img/tjanster/översätt2.jpg" alt=""/>
                            </div>
                            <div class="featured-box">
                                <div class="box-content">
                        ...
                        <li class="appear-animation" data-appear-animation="fadeInUp">
                            <div class="thumb">
                                <img src="img/tjanster/översättning.jpg" alt=""/>
                            </div>
                            <div class="featured-box">
                                <div class="box-content">
                                    <h4 class="heading-primary mb-xl"><strong>Korrekturläsning</strong></h4>
                                    <p>Grammatik, stavning och avstavningar kontrolleras ingående.</p>
                                </div>
                            </div>
                        </li>
                        <li class="appear-animation" data-appear-animation="fadeInUp">
                            ...
                            <div class="featured-box">
                                <div class="box-content">
                                    <h4 class="heading-primary mb-xl"><strong>Textredigering</strong></h4>
                                    <p>Bearbetning och målgruppsanpassning sker av manus på svenska eller andra
                                        språk.</p>
                                </div>
                            </div>
                        </li>
                        <li class="appear-animation" data-appear-animation="fadeInUp">
                            <div class="thumb">
                                <img src="img/tjanster/kollegor.jpg" alt=""/>
                            </div>
                            <div class="featured-box">
                                <div class="box-content">
                        ...
                        <li class="appear-animation" data-appear-animation="fadeInUp">
                            <div class="thumb">
                                <img src="img/tjanster/bokstäver.jpg" alt=""/>
                            </div>
                            <div class="featured-box">
                                <div class="box-content">
                ...
                <div class="col-md-3">
                    <h2 class="heading-quaternary mb-xl mt-lg">Fler exempel på översättningar som vi gör</h2>
                    <ul class="list list-icons list-primary">
                        ...
                        <li class="appear-animation fadeInUp appear-animation-visible" data-appear-animation="fadeInUp"
                            data-appear-animation-delay="300" style="animation-delay: 300ms;">
                            <i class="fa fa-check"></i>
                        ...
                        <li class="appear-animation fadeInUp appear-animation-visible" data-appear-animation="fadeInUp"
                            data-appear-animation-delay="1200" style="animation-delay: 1200ms;">
                            <i class="fa fa-check"></i>
                            EU-dokumentation.
                        </li>
                        <li class="appear-animation fadeInUp appear-animation-visible" data-appear-animation="fadeInUp"
