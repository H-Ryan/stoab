  ...
  <body>
          ...
          <div class="container">
            ...
            <div class="row" style="margin-top: 10px;">
              <div class="col-md-10 col-md-push-1">
                ...
                <form class="form-horizontal" id="policyForm" novalidate="novalidate" method="post">
                  <div class="form-group">
                      <label class="col-sm-2 control-label" for="name">Namnförtydligande:</label>
                      <div class="col-sm-10">
                          <input type="text" name="name" id="name" class="form-control"
                                 placeholder="Namnförtydligande"
                                 data-rule-maxlength="90"
                                 data-rule-minlength="3"
                                 data-msg-required="Skriv ditt namnförtydligande."
                                  data-rule-required="true"
                                 data-msg-minlength="Namnet bör innehålla mer än tre tecken."
                                 data-msg-maxlength="Den kund området bör innehålla mer än 90 tecken."
                                 maxlength="90">
                      </div>
                  </div>
                  <div class="form-group">
                      <label class="col-sm-2 control-label" for="personalNumber">Personnummer:</label>
                      <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="city_date">Ort/Datum:</label>
                      <div class="col-sm-10">
                            <input type="text" name="city_date" id="city_date" class="form-control"
                                       placeholder="Ort/Datum"
                                       data-rule-maxlength="90"
                                       data-rule-minlength="5"
                                       data-rule-required="true"
                                       required
                                       data-msg-required="Fält Ort/Datum krävs."
                                       data-msg-minlength="Fält Ort/Datum bör innehålla mer än 5 tecken."
                                       data-msg-maxlength="Fältet Ort/Datum bör innehålla mindre än 5."
                                       maxlength="90">
                      </div>
                   </div>
                   <div class="form-group">
                       ...
                       <div class="col-md-12">
                           <button type="button" id="btnSubmit" class="btn btn-primary pull-right mr-md"
    ...
    (function ($) {
        ...
        btnSubmit.on("click", function (e) {
            e.preventDefault();
            var validated = policyForm.valid();
            if (validated) {
                $.ajax({
                    type: "POST",
                    url: "./src/misc/policy.php",
