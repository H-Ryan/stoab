                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="featured-box featured-box-quaternary  featured-box-effect-1 mt-xlg">
                            <div class="box-content">
                                <a href="tjanster-tolkning.php"><i class="icon-featured fa fa-group"></i></a>
                                <h4 class="text-uppercase">Tolkning</h4>
                                <p>Vi erbjuder tolkning som möjliggör kommunikation när språkbarriärerna blir för stora
                                    mellan två eller flera personer. Våra anslutna tolkar har kompetens till och med
                                    auktorisation enligt kammarkollegiet.</p>
                                <p><a href="tjanster-tolkning.php" class="lnk-quaternary  learn-more">Läs mer <i
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="featured-box featured-box-secondary featured-box-effect-1 mt-xlg">
                            <div class="box-content">
                                <a href="tjanster-oversattning.php"><i class="icon-featured fa fa-book"></i></a>
                                <h4 class="text-uppercase">Översättning</h4>
                                ...
                                <p><a href="tjanster-oversattning.php" class="lnk-secondary learn-more">Läs mer <i
                                            class="fa fa-angle-right"></i></a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="featured-box featured-box-primary featured-box-effect-1 mt-xlg">
                            <div class="box-content">
                                <a href="tjanster-sprakanalys.php"><i class="icon-featured fa fa-bar-chart"></i></a>
                                <h4 class="text-uppercase">Språkanalys</h4>
                                <p>Språkanalys är ett utlåtande från en lingvist, som tillsammans med en språkexpert med
                                    en specifik språkbakgrund lyssnar på en bandinspelning.</p>
                                <p><a href="tjanster-sprakanalys.php" class="lnk-primary learn-more">Läs mer <i
                                            class="fa fa-angle-right"></i></a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="featured-box featured-box-tertiary featured-box-effect-1 mt-xlg">
                            <div class="box-content">
                                <a href="tjanster-kurser.php"><i class="icon-featured fa fa-files-o"></i></a>
                                <h4 class="text-uppercase">Kurser</h4>
                                <p>Kurser för nyanlända som ska etablera sig i Sverige. Introduktionskurs för blivande
                                    tolkar.</p>
                                <p><a href="tjanster-kurser.php" class="lnk-tertiary learn-more">Läs mer <i
                                            class="fa fa-angle-right"></i></a></p>
                            </div>
                        </div>
                    </div>
