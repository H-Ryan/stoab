...
if (isset($_POST['name']) && isset($_POST['clientNumber'])
    ...
    if (isset($_FILES['attachment']) && $_FILES['attachment']['error'] == UPLOAD_ERR_OK) {
        echo json_encode(["error" => !$emailer->send_email_with_attachment("info@tolktjanst.se", "STÖ AB", "Beställning av översättning", $emailContent, $_FILES['attachment']['tmp_name'], $_FILES['attachment']['name'])]);
    } else {
