...
<div class="body">
    ...
    <div role="main" class="main">
        ...
        <div role="main" class="main">
            <div class="kvalitet container" id="interna-medarbetare">
                <div class="row pt-lg pr-xs pl-xs">
                    <div class="col-md-12">
            ...
            <div class="kvalitet container" id="externa-medarbetare">
                <div class="row pt-lg">
                    <div class="col-md-12">

                        <h1 class="center heading-primary text-xl mt-lg mb-xl">Våra externa medarbetare</h1>

                        <p class="lead">Våra anslutna tolkar, översättare och kontaktpersoner är otroligt viktiga för
                            oss och det arbetar vi i stor utsträckning för att visa dem.<br/><br/>Vi genomför därför
                            regelbundna kvalitetsundersökningar så att de externa medarbetarna får vara med att tycka
                            till och ge förslag på nya idéer som hjälper oss i vårt arbete. Genom dessa
                            kvalitetsundersökningar kan vi på ett enkelt sätt följa den linje av kvalitet som vi önskar.
                        </p>
                    </div>
                </div>
            </div>

            <div class="kvalitet container" id="kunder">
                <div class="row pt-lg">
                    <div class="col-md-12">

                        <h1 class="center heading-primary text-xl mt-lg mb-xl">Våra kunder</h1>

                        <p class="lead">För att kunna erbjuda det kunden vill ha görs regelbundna
                            kundnöjdhetsundersökningar.<br/><br/>Kunders behov är föränderliga och genom att ha en nära
                            relation med dem kan vi anpassa våra tjänster efter deras önskemål snabbare.<br/><br/>Vi ska
                            även vara så transparenta att kunderna känner fullt förtroende för oss som leverantör. Genom
                            att känna förtroende över gränserna blir det lättare för kunderna att vidarebefordra en
                            konstruktiv feedback till oss som leverantör.
                        </p>
                    </div>
                </div>
            </div>

            <div class="kvalitet container" id="samhallet">
                <div class="row pt-lg">
                    <div class="col-md-12">
            ...
            <div class="kvalitet container" id="miljo">
                <div class="row pt-lg">
                    <div class="col-md-12">
...
<script type="text/javascript">
    $(document).ready(function () {
        var option = 'interna-medarbetare',
