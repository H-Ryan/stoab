(function($) {
    ...
    var loginForm = $('#frmLogIn'),
        ...
        forgotPassBlockedError = $('#forgotPassBlockedError'),
        ...
        forgotInterpreterPassBlockedError = $('#forgotInterpreterPassBlockedError'),
                    ...
                    if (typeof data.responseJSON === 'object') {
                        ...
                        switch (data.responseJSON.error) {
                            case 0:
                                ...
                                forgotPassBlockedError.addClass('hidden');
                            ...
                            case 5:
                            case 6:
                                forgotPassBlockedError.removeClass('hidden');
                                forgotPassButton.removeClass('disabled');
                                break;
                            default:
