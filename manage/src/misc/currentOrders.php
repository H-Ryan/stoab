...
if(isset($_POST['code']) && isset($_POST['currentPage']))
{
    ...
    try {
        ...
        $statement = $con->prepare("SELECT o_orderNumber, o_kundNumber, o_orderer, o_language, o_interpretationType, o_date, o_startTime, o_endTime, o_state FROM t_order WHERE o_date >= CURRENT_DATE ORDER BY o_date DESC LIMIT :start, 10");
