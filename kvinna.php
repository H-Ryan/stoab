...
<head>
    <title>
        STÖ AB - Sarvari tolkning och översättning / Samhällskurs för nyanlända
    </title>
    <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="preffix_2 grid_8">
                        <h2 class="header_1 wrap_3 color_3">
                            Att vara kvinna i Sverige-kurs för nyanlända
                        </h2>
                    </div>
                </div>
                <div class="row">
                    <div class="grid_12">
                        <div class="box_1">
                            <p class="text_3">
                                ...
                                <br/><br/>
                                Mål<br/>Vår målsättning är att nyanlända ska lära sig känna till den svenska lagen när
                                det gäller äktenskap och samboförhållande. Du ska också känna till föräldraförsäkring
                                och barns rättigheter men också mer om skola, förskola och fritidshem.<br/><br/>
                            </p>
                        </div>
                    </div>
                    <div class="grid_8">
                        <div class="wrap_10">
                            <h2 class="header_2 indent_3">
                                I kursen ingår information om:
                            </h2>
                            <ul class="list_2 text_3 color_5">
                                <li>Skillnader på arbetsplatser i deras länder och i Sverige</li>
                                <li>Vad som krävs för att lyckas med karriären i Sverige</li>
                                <li>Att bilda familj och leva med barn i Sverige</li>
                                <li>Öka självförtroende</li>
                                <li>Att påverka Sverige</li>
                                <li>Tips för kvinnor</li>
                                <li>Vett och etikett i svenska samhället</li>
                                <li>Vägledning till positivt tänkande</li>
                            </ul>
                        </div>
                    </div>
                    <div class="grid_12">
                        <div class="box_1">
                            <p class="text_3">
                                Undervisningsform<br/>Undervisningen kommer ske i förläsningsform och det finns utrymme
                                för diskussioner och frågor. Undervisaren delar ut material som krävs.
                                <br/><br/>
                                Anmälan<br/>Du anmäler dig genom att skicka dina personuppgifter till e-post
                                kurs@tolktjanst.se. Observera att anmälan är bindande.
                            </p>
                        </div>
                    </div>
                </div>
